	VGA_Subsystem u0 (
		...
		.vga_pixel_dma_avalon_pixel_source_ready         (<connected-to-vga_pixel_dma_avalon_pixel_source_ready>),         // vga_pixel_dma_avalon_pixel_source.ready
		.vga_pixel_dma_avalon_pixel_source_startofpacket (<connected-to-vga_pixel_dma_avalon_pixel_source_startofpacket>), //                                  .startofpacket
		.vga_pixel_dma_avalon_pixel_source_endofpacket   (<connected-to-vga_pixel_dma_avalon_pixel_source_endofpacket>),   //                                  .endofpacket
		.vga_pixel_dma_avalon_pixel_source_valid         (<connected-to-vga_pixel_dma_avalon_pixel_source_valid>),         //                                  .valid
		.vga_pixel_dma_avalon_pixel_source_data          (<connected-to-vga_pixel_dma_avalon_pixel_source_data>),          //                                  .data
